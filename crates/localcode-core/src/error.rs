...
impl ErrorCode {
    pub fn as_str(self) -> &'static str {
        match self {
            ...
            Self::BackendInstallFailed => "BACKEND_INSTALL_FAILED",
            ...
            Self::RemoteConnectFailed => "REMOTE_CONNECT_FAILED",
            Self::RemoteAuthFailed => "REMOTE_AUTH_FAILED",
            Self::RemoteCommandFailed => "REMOTE_COMMAND_FAILED",
            Self::RemoteProvisionFailed => "REMOTE_PROVISION_FAILED",
            Self::RemoteTunnelFailed => "REMOTE_TUNNEL_FAILED",
